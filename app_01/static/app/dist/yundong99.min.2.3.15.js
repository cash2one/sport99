...
function($scope, $rootScope, $location, $routeParams, $http, ngDialog){
    ...
    $scope.cancel = function(){
            var dialog = ngDialog.open({ template: 'cancel',
                className: 'ngdialog-theme-plain ngdialog_page',
                appendTo: '#event',
                scope: $scope
            });
    ...
    $scope.join = function(){
        var dialog = ngDialog.open({ template: 'join',
...
eventController.controller('EventMembersController',
    ...
    $scope.ids= []
    $scope.toggle_select =function(id){
        var has = false;
        var copy = [];
    ...
    $scope.remove = function(){
        ...
        var dialog = ngDialog.open({ template: 'remove',
            className: 'ngdialog-theme-plain ngdialog_page',
    ...
    $scope.add_picker = function(){
        //$scope.mate_count = 0;
        var dialog = ngDialog.open({ template: 'add',
